...
-->
## Eye, Ear, Nose, Mouth, and Face Detection( README will be updated soon)
...
1. Clone the repo
   ```sh
   git clone https://github.com/zoumson/EyeEarNoseMouthFaceDetection.git
   ```
2. Go to the project directory source
   ```sh
   cd EyeEarNoseMouthFaceDetection
   ```
...
Project Link: [https://github.com/zoumson/EyeEarNoseMouthFaceDetection](https://github.com/zoumson/EyeEarNoseMouthFaceDetection.git)
