...
int main(int argc, char* argv[])
{
   ...
   String keys =
        ...
        "{n nose |./resource/haarcascade/haarcascade_mcs_nose.xml   | nose haarcascade}"                        
        "{help h usage ?    |      | show help message}";      
  
    CommandLineParser parser(argc, argv, keys);
    parser.about("Nose  Detection");
    if (parser.has("help")) 
    {
        parser.printMessage();
        return 0;
    ...
    String noseCascadeName = parser.get<String>("nose"); 
