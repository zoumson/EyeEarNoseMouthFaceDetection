...
int main(int argc, char* argv[])
{
  ...
  String keys =
        ...
        "{k mask|./resource/image/glasses.jpg   | mask image}"         
        "{f face |./resource/haarcascade/haarcascade_frontalface_alt.xml   | frontal face haarcascade}"         
        "{e eye |./resource/haarcascade/haarcascade_eye.xml   | nose haarcascade}"                        
    ...
    String eyeCascadeName = parser.get<String>("eye"); 
