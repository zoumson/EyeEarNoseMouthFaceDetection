...
int main(int argc, char* argv[])
{
   ...
   cv::String keys =
        ...
        "{l left |./resource/haarcascade/haarcascade_mcs_leftear.xml   | left ear haarcascade}"         
        "{r right |./resource/haarcascade/haarcascade_mcs_rightear.xml   | right ear haarcascade}"                        
    ...
    String leftEarCascadeName = parser.get<String>("left");
    String rightEarCascadeName = parser.get<String>("right"); 
